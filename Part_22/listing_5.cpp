...
int main(int argc,char** argv){
    ...
    QSignalTransition* ptrans1=pStateOff->addTransition(pcmd,&QPushButton::clicked,pStateOn);
    QSignalTransition* ptrans2=pStateOn->addTransition(pcmd,&QPushButton::clicked,pStateOff);
